  ...
  return (
    <Card bordered>
      ...
      <p className="mt-2 text-[var(--color-navy)]">
        ...
        y tienes <strong>{gate.attemptCap ?? evaluation.maxAttempts}</strong> intentos
      ...
      <p className="mt-1 text-sm text-[var(--color-muted)]">
        {gate.usedAttempts > 0
          ? `Este sería el intento ${gate.usedAttempts + 1} de ${gate.attemptCap ?? evaluation.maxAttempts}.`
